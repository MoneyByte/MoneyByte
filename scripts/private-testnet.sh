...
./moneybyted --datadir=./test1 &
./moneybyted --datadir=./test2 &
./moneybyted --datadir=./test3 &
./moneybyted --datadir=./test4 &
./moneybyted --datadir=./test5 &
./moneybyted --datadir=./test6 &
./moneybyted --datadir=./test7 &
